...
primaryNavButtons.push(() => {
    const newListItem = document.createElement('li');
    newListItem.innerHTML = `
    <svg style="rotate:-90deg" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
    ...
    newListItem.addEventListener('click', () => {
        activeNavHelper({
            heading: "Key Input",
            description: "Several settings for key inputs.",
            sections: [
                {
...
document.addEventListener('DOMContentLoaded', () => {
    const primaryList = document.querySelector("nav > .ul-wrapper > .primary > ul");
...
//             let activeNav = document.querySelector("nav > .ul-wrapper > .secondary > ul");
...
//                 ulWrapper.classList.add('changing-activeNavOptions')
//                 setTimeout(() => {
//                     let activeNavOptions = document.querySelectorAll("nav > .ul-wrapper > .secondary > ul > li"); // refresh the let
...
//         })
//     });
//     secNavActive("nav > .ul-wrapper > .primary > ul > #keyboardSelector", keyboardSelectorOptions, { ref: setKeyboard, value: "/keyboard/generic.html" })
...
//         fnInput: false
//     }]
//     secNavActive("nav > .ul-wrapper > .primary > ul > #keyInput", keyInputOptions)
...
//         document.querySelector("nav > .ul-wrapper > .primary > ul > #keyInput").innerHTML = newVal ? rawInputEl : processedInputEl
//     })
// })