<script>
    import { searchInput, keyboardIsRawKeyInput, searchResults, loadShortcuts, keyboardActiveKeys, searchQueryTime, searchIsCaseSensitive, searchIncludeDescription, isSearchVisible, keyboardIsPause, softwareList, editingShortcutData } from '../store.js';
            ...
            <li>
                <div class="title-wrapper">
                    ...
                    <div class="options-wrapper">
                        ...
                        <span title="Edit" on:click={() => $editingShortcutData = shortcut} style="cursor: pointer;">
                            <span></span>
